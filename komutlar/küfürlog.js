...
.setDescription(`<a:Neptunered:770187639801774080> **HATA** <a:Neptunered:770187639801774080> - Bir kanal etiketle.`)
      ...
      message.channel.send(`<a:Neptuneonay:770187690402250772> **Başarılı ile küfür log kanalı ayarlandı.** `).then(l => {
      l.delete({timeout: 5000})
    })
    }else{
     message.channel.send(`<a:Neptunered:770187639801774080> **Küfür engel açık değil.**`).then(l => {
      l.delete({timeout: 5000})
    })
    }
    }
