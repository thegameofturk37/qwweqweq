...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(`<a:Neptunered:770187639801774080> <@${nesne}> adlı kişinin gold üyeliğini başarıyla kaldırdım.`)
...
if (client.users.cache.get(''+nesne+'').send(`<a:Neptunered:770187639801774080> \`Gold üyeliğiniz kaldırıldı.\` <a:Neptunered:770187639801774080>`)){
