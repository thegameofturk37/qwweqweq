...
const yardım = new Discord.MessageEmbed()
  .setAuthor(`Neptune Yardım Menüsü`, client.user.avatarURL())
  .setColor("0x36393F")
  ...
  .addField(" • Linkler:", "• [Davet Et](https://discord.com/oauth2/authorize?client_id=727962543347335179&permissions=8&scope=bot/) • [Destek Sunucusu](https://discord.gg/usg73fH) • [Web Site](https://www.Neptunesite.cf/) •")
  .setImage("https://cdn.discordapp.com/attachments/769957882166116353/769974488670011422/standard.gif")
.setFooter("Neptune", message.author.avatarURL())
.setTimestamp()
