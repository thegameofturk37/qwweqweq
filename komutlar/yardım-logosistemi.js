...
exports.run = (client, message) => {
 ...
 .setDescription(`
<a:Neptunebyzsyhtik:769976055715856384> **${WestraPrefix}arrow** \n-> Ok şeklinde logo yapar.
<a:Neptunebyzsyhtik:769976055715856384> **${WestraPrefix}gold** \n-> Altın şeklinde logo yapar.
<a:Neptunebyzsyhtik:769976055715856384> **${WestraPrefix}green** \n-> Yeşil şeklinde logo yapar.
<a:Neptunebyzsyhtik:769976055715856384> **${WestraPrefix}graffiti** \n-> Graffiti şeklinde logo yapar.
`)
 .setFooter(`Neptune`)
 .setTimestamp()
 .setImage(WestraGif)
