...
exports.run = (client, message, args) => {
    ...
    if(!öneri) return message.channel.send("<a:Neptunered:770187639801774080> Bir öneri belirtmelisin. ")
...
//.setTitle("Bana bir öneride bulundular!")
  ...
  message.channel.send(`<a:Neptunebyzsyhtik:769976055715856384> Öneriniz başarıyla iletildi!`)
