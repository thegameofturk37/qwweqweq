...
.setDescription(`<a:Neptunered:770187639801774080> **HATA** <a:Neptunered:770187639801774080> - Bu sunucuda yetkili değilsin.`)
      ...
      message.channel.send(`<a:Neptunered:770187639801774080> **Başarılı ile küfür engel kapandı.**`).then(l => {
      l.delete({timeout: 5000})
    })
    }else{
      db.set(`küfür.${message.guild.id}.durum`,true)
      message.channel.send(`<a:Neptuneonay:770187690402250772> **Başarılı ile küfür engel açıldı.**`).then(l => {
      l.delete({timeout: 5000})
    })
    }
    }
