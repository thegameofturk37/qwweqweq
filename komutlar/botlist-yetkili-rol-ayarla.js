...
module.exports.run = async (client, message, args) => {
  ...
  let rol = message.mentions.roles.first();   
    if (!rol) {
      message.channel.send(`<a:Neptunered:770187639801774080> Bir rol etiketlemelisin!`);
      return;
    }
 db.set(`westrabotlistyetkilirol_${message.guild.id}`, rol.id);
  message.channel.send(`<a:Neptuneonay:770187690402250772> Botlist yetkilisi rolü başarıyla ${rol} olarak ayarlandı!`)
}
