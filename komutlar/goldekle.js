...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(`<a:Neptuneonay:770187690402250772> <@${nesne}> adlı kişinin gold üyeliğini başarıyla aktif ettim.`)
...
if (client.users.cache.get(''+nesne+'').send(`<a:Neptunegold:771378702479130675> \`Gold üyeliğiniz aktif edildi.\` <a:Neptunegold:771378702479130675>`)){
