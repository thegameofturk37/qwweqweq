...
module.exports.run = async (client, message, args) => {
  ...
  let kanal = message.mentions.channels.first();
    if (!kanal) {
      message.channel.send(`<a:Neptunered:770187639801774080> Bir kanal etiketlemelisin!`);
      return;
    }
 db.set(`westrabasvuruyapılacakkanal_${message.guild.id}`, kanal.id);
  message.channel.send(`<a:Neptuneonay:770187690402250772> Başvuru yapılacak kanal başarıyla ${kanal} olarak ayarlandı!`)
}
